...
\begin{abstract}
  ...
  learning. We present \textit{BachBot}: a deep LSTM model for automatic
  ...
  minimizes prior assumptions and utilizes LSTM without modification. While
  this is not the first application of deep LSTM to Bach chorales, our work
  consists of the following novel contributions.
