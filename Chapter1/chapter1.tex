...
results convincingly suggest an affirmative answer.
...
While our modelling framework is capable of modelling any encoded music
...
Bach's composition style on both harmonization and automatic composition tasks.
...
With advances in computing and progress in modelling methods and algorithms,
computational modelling has started to provide novel insights into various
