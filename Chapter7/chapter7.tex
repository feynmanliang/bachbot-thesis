...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=1.0\linewidth]{model-analysis-tokens-0.png}
    \includegraphics[width=1.0\linewidth]{model-analysis-tokens-1.png}
    \includegraphics[width=1.0\linewidth]{model-analysis-tokens-2.png}
    \includegraphics[width=1.0\linewidth]{model-analysis-tokens-3.png}
    \includegraphics[width=1.0\linewidth]{model-analysis-tokens-4.png}
    \includegraphics[width=1.0\linewidth]{model-analysis-tokens-5.png}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=1.0\linewidth]{model-analysis-chords-0.png}
    \includegraphics[width=1.0\linewidth]{model-analysis-chords-1.png}
    \includegraphics[width=1.0\linewidth]{model-analysis-chords-2.png}
    \includegraphics[width=1.0\linewidth]{model-analysis-chords-3.png}
    \includegraphics[width=1.0\linewidth]{model-analysis-chords-4.png}
    \includegraphics[width=1.0\linewidth]{model-analysis-chords-5.png}
...
\begin{figure}[htpb]
    \centering
    ~~\includegraphics[width=0.99\linewidth]{model-analysis-input-piano-roll.png}
    \includegraphics[trim={0 0 0 1.4cm},clip,width=1.0\linewidth]{model-analysis-probabilistic-piano-roll.png}
