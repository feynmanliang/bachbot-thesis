...
\begin{enumerate}
    ...
    \item A modified version of \texttt{torch-rnn} supporting harmonization and
        UTF8 token sequences (\path{bachbot/scripts/harm\_model})
    ...
    \item Harmonization with a trained model (\path{bachbot/scripts/harm\_model/harmonize.lua})
...
\begin{enumerate}
    \item \path{bachbot/scripts/0-prepare\_all.zsh} -- prepares preprocessed and encoded corpuses
