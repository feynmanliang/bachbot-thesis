...
In order to use LSTM as a model for music, we make the following assumptions
...
\mynote{We restrict our attention to Bach chorales: Describe Bach and chorales, 4 parts, soprano lead with ATB harmony,
...
software library for high-level specification of neural network models. \Cref{fig:theanets-architecture}
...
an optimized implementation of LSTM provided by \texttt{torch-rnn} \mynote{citep}.
