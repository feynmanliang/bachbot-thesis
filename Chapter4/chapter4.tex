...
\begin{enumerate}
  ...
  \item The structure of chorales are regular: all chorales have four parts and
    ...
    of its own\citep{nattiez1990music}. It is well known\todo{citep} that Bach
...
an optimized implementation of LSTMs provided by \texttt{torch-rnn} \todo{citep}.

Models were trained using RMSProp \todo{citep} with batch normalization \todo{citep}
...
at $t$ \todo{citep Mikolov} and truncated after \texttt{seq\_length} time steps.
...
\todo{Compare with \citep{Allan2005} and \citep{Brien2016}}.
